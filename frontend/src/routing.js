...
export function noticeCopy(incidentType, report) {
  ...
  return {
    ...
    lead: 'After you submit, the photo is read to judge what is actually in the scene. Stay-back or cleanup instructions follow the picture, not the category you tapped. If people are in immediate danger, contact local emergency services first. EarthRelay files a case; it does not replace emergency response.',
  }
}
