...
import { displayCaseId, hasIncidentPhoto, incidentTypeLabel, useEarthRelay } from './context.jsx'
...
export function AssignBoard() {
  ...
  const openCases = [...er.cases.filter((item) => item.status !== 'resolved' && hasIncidentPhoto(item))].sort((a, b) => {
