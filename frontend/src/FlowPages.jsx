...
import { incidentTypeLabel, reporterDisplayName, reporterMention, useEarthRelay } from './context.jsx'
  ...
  return (
    <div className="page-scroll">
      ...
      <div className="page-body">
        ...
        {er.uploading && (
          <p className="pin-note">Reading the photo for type and severity. This can take about 15 seconds.</p>
        )}
...
export function NearbyCases() {
  ...
  return (
    <div className="page-scroll">
      ...
      <div className="page-body">
        <p className="pin-note">Other filings within about 1 km of this GPS pin.</p>
