...
export default function WhoYouAre() {
  ...
  return (
    <div className="page-scroll who-page">
      ...
      <form className="who-form" onSubmit={onSubmit} noValidate>
        <div className={`who-gps who-gps-line ${show('gps') ? 'is-invalid' : ''}`}>
          <GpsStatus gps={gps} compact={gps.status?.kind !== 'blocked'} />
          {gps.status?.kind !== 'on' && (
        ...
        <div className="who-panel is-open">
          <p className="who-col-title">Incident</p>
          ...
          <div className={`who-step ${show('category') ? 'is-invalid' : ''}`}>
            ...
            <p className="pin-note">
              Required. The photo and this category are both used. If the photo strongly shows a
              different type, the photo is filed.
            </p>
            <label>
        ...
        <div className="who-panel is-open">
          <p className="who-col-title">You</p>
          <div className="who-step">
            ...
            <label>
              ...
              <input
                ...
                autoComplete="tel"
                inputMode="tel"
                placeholder="e.g. +92 314… or 0314… (any country)"
                value={phone}
